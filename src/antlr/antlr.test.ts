...
describe("antlr", () => {
  ...
  const cases: Array<{
    ...
    },
    {
      ...
      sql:
        "select account_type::json->'b' as f1, " +
        "'[1,2,3]'::json ->> 2 as f2, account_id#>account_type as f3, account_parent#>>account_id as f4 " +
        "from account",
      data: [
        {
          type: "table",
    ...
    {
      name: "Column aliases within query alias",
      sql:
    ...
    {
      mergedLeaves: true,
      name: "Subquery in IN, EXISTS, expression",
      sql:
        "select account_id in (select 1 as c union select 2) " +
        "from account a " +
        "where exists (select 1 from employee where employee_id = a.account_id) and " +
        "account_type = (select 'abcd')",
      data: [
        {
          type: "table",
          id: "result_2",
