...
const SqlTypeName = createToken({
  name: "SqlTypeName",
  pattern: /CHARACTER|CHAR|CHAR VARYING|VARCHAR|CHARACTER VARYING|VARCHAR|DATE|TIME|TIMESTAMP|CHARACTER SET|GEOMETRY|DECIMAL|DEC|NUMERIC|INTEGER|INT|BOOLEAN|BINARY|BINARY VARYING|BINARY VARBINARY|TINYINT|SMALLINT|BIGINT|REAL|DOUBLE|FLOAT|ANY/i,
  longer_alt: Identifier
});
